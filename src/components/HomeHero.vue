...
<template>
  <section class="relative bg-gradient-to-br from-primary-600 via-primary-700 to-primary-900 min-h-screen overflow-hidden hero-section">
    ...
    <div class="absolute inset-0 overflow-hidden opacity-20">
      ...
      <div class="absolute left-1/4 top-20 w-32 h-32 bg-primary-300 rounded-full animate-bounce-light" style="animation-delay: 3s"></div>
    </div>
    ...
    <div class="absolute inset-0 overflow-hidden opacity-30">
      ...
      <div class="absolute top-1/2 right-20 w-2 h-2 bg-accent-200 rounded-full animate-bounce-light" style="animation-delay: 3.5s"></div>
    </div>
    ...
    <div class="container-site relative z-10 py-20 sm:py-24 md:py-32 lg:py-40">
      <div class="grid lg:grid-cols-2 gap-12 md:gap-16 items-center">
        ...
        <div class="space-y-6 sm:space-y-8 max-w-2xl">
          ...
          <!-- Main Headline -->
          <h1 class="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-white animate-slide-up leading-tight">
            Building Digital
            <span class="block text-accent-300 animate-slide-up" style="animation-delay: 0.1s">
              Experiences
            </span>
            <span class="block text-primary-100 animate-slide-up" style="animation-delay: 0.2s">
              That Convert
            </span>
          </h1>
          ...
          <div class="flex flex-col sm:flex-row gap-4 pt-6 animate-slide-up" style="animation-delay: 0.4s">
            <a href="/services" class="btn-primary btn-lg hover:text-white text-center transform hover:scale-105 transition-all duration-300 shadow-lg inline-flex items-center justify-center gap-2">
              Explore Services
              <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 8l4 4m0 0l-4 4m4-4H3"></path>
              </svg>
            </a>
            <a href="/portfolio" class="btn-outline btn-lg text-center text-white border-white hover:bg-white hover:text-primary-600 transform hover:scale-105 transition-all duration-300">
              View Our Work
            </a>
          </div>

          <!-- Enhanced Trust Indicators -->
          <div class="flex flex-wrap items-center gap-8 pt-8 animate-slide-up" style="animation-delay: 0.5s">
            <div class="flex items-center gap-3">
              ...
              <div>
                <div class="text-sm font-semibold text-white">100+ Projects</div>
            ...
            <div class="flex items-center gap-3">
              ...
              <div>
                <div class="text-sm font-semibold text-white">98% Satisfaction</div>
            ...
            <div class="flex items-center gap-3">
              <div class="bg-accent-600 bg-opacity-30 rounded-full p-2">
                <svg class="h-6 w-6 text-accent-200" fill="currentColor" viewBox="0 0 20 20">
        ...
        <div class="relative flex justify-center lg:justify-end animate-fade-in" style="animation-delay: 0.2s">
          <div class="relative w-full max-w-lg lg:max-w-full">
            ...
            <div class="hidden lg:block absolute top-1/2 -left-8 bg-gradient-to-br from-accent-500 to-accent-600 p-4 rounded-2xl shadow-xl z-20 transform animate-bounce-light" style="animation-delay: 2s">
