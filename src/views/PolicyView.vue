  ...
  <div class="bg-neutral-cream min-h-screen">
    ...
    <div class="bg-primary-600 py-12">
      <div class="container-site">
        <h1 class="text-neutral-50 mb-2">Legal Policies</h1>
        <p class="text-primary-100 text-lg mb-0">Last Updated: March 4, 2025</p>
      </div>
    </div>
    ...
    <div class="container-site section-padding">
      <div class="max-w-content mx-auto">
        <!-- Navigation Tabs -->
        <div
          class="bg-white rounded-t-lg shadow-sm p-2 flex border-b border-primary-200"
        >
          <button
            v-for="tab in tabs"
            :key="tab.id"
            ...
            :class="[
              'py-3 px-5 font-heading font-medium text-base rounded-md transition-all duration-200 focus:outline-none',
              activeTab === tab.id
        ...
        <!-- Content Section -->
        <div class="bg-white rounded-b-lg shadow-card p-8">
          <!-- Privacy Policy -->
          <div v-show="activeTab === 'privacy'" class="animate-fade-in">
            <h2>Privacy Policy</h2>

            <!-- Introduction -->
            <section class="mb-8">
              <p>
                Thank you for choosing to be part of our community at [Company
                Name] ("Company", "we", "us", or "our"). We are committed to
              ...
              <p>
                ...
                our website, mobile application, and/or any related services,
            ...
            <section class="mb-8">
              ...
              <p>
                ...
                us when registering for our Services, expressing an interest in
            ...
            <section class="mb-8">
              ...
              <ul class="list-disc pl-6">
                ...
                <li>
                  To send administrative information (such as changes to our
                  terms, conditions, and policies)
                </li>
                <li>
                  To personalize user experience and to allow us to deliver the
                  type of content and product offerings that most interests you
                </li>
                <li>
            ...
            <section class="mb-8">
              ...
              <p>
                ...
                to fulfill business obligations. We may process or share data
              ...
              <ul class="list-disc pl-6">
                ...
                <li>
                  To protect our rights and property, and the safety of our
                  users
                </li>
              </ul>
            </section>
            ...
            <section class="mb-8">
              ...
              <p>
                ...
                account at any time. You may have the right to:
              </p>
              <ul class="list-disc pl-6">
            ...
            <section>
              ...
              <p>
                ...
                email us at [contact email] or by post to:
              </p>
            </section>
          </div>

          <!-- Cookies Policy -->
          <div v-show="activeTab === 'cookies'" class="animate-fade-in">
            ...
            <section class="mb-8">
              <p>
                ...
                are, how we use them, the types of cookies we use, the
                information we collect using cookies and how that information is
                used, and how to control your cookie preferences.
              </p>
              <p>
                ...
                website function properly, make the website more secure, provide
                better user experience, and understand how the website performs
                and to analyze what works.
              </p>
            </section>
            ...
            <section class="mb-8">
              ...
              <p>
                Like most online services, our website uses cookies for a number
                of reasons, like protecting your data and account, improving our
                website's performance, remembering your preferences, and
                generally providing you with a better experience. We use cookies
              ...
              <ul class="list-disc pl-6">
                ...
                <li>
                  Analytics cookies: These cookies collect information about how
                  visitors use our website.
                </li>
                <li>
                  Marketing cookies: These cookies track your online activity to
                  help advertisers deliver more relevant advertising.
                </li>
                <li>
                  Preference cookies: These cookies enable the website to
                  provide enhanced functionality based on your preferences.
                </li>
              </ul>
            </section>
            ...
            <section class="mb-8">
              ...
              <h4 class="mt-4">Session Cookies</h4>
              <p>
              ...
              <h4 class="mt-4">Persistent Cookies</h4>
              <p>
              ...
              <h4 class="mt-4">Third-Party Cookies</h4>
              <p>
                We may use third-party service providers to monitor and analyze
                the use of our website. These third-party service providers may
                use their own cookies to collect information about how you and
            ...
            <!-- Your Cookie Choices -->
            <section class="mb-8">
              <h3>3. Your Cookie Choices and Control</h3>
              <p>
                You can manage your cookie preferences by changing your browser
                settings to block or notify you when cookies are being set.
                Please note that if you decide to disable cookies, some features
              ...
              <ul class="list-disc pl-6">
                ...
                <li>
                  Block cookies by activating the setting on your browser to
                  refuse cookies
                </li>
                <li>Allow cookies from specific websites</li>
              </ul>
              <p>
                If you disable cookies, please note that some parts of our
            ...
            <!-- Cookie Updates -->
            <section>
              <h3>4. Updates to this Cookies Policy</h3>
              <p>
                We may update our Cookies Policy from time to time to reflect
                changes in technology, regulations, or our business practices.
                Any changes will become effective when we post the revised
                Cookies Policy on our website. We recommend that you check this
          ...
          <div v-show="activeTab === 'terms'" class="animate-fade-in">
            ...
            <section class="mb-8">
              <p>
                ...
                of the services, including our website, APIs, email
                notifications, applications, buttons, widgets, and our other
                covered services (collectively, "Services") that are provided by
            ...
            <!-- Access to Services -->
            <section class="mb-8">
              <h3>1. Access to Services</h3>
              <p>
                You may access and use our Services only if you agree to form a
                binding contract with us and are not a person barred from
            ...
            <section class="mb-8">
              ...
              <p>
                ...
                strong password and limit its use to this account. We cannot and
              ...
              <p>
                ...
                Services by adjusting your settings. By providing us with your
                email address, you consent to our using the email address to
                send you Service-related notices.
              </p>
            </section>

            <!-- Content and Licenses -->
            <section class="mb-8">
              <h3>3. Content and Licenses</h3>
              <p>
              ...
              <p>
                ...
                that you submit, post, or display on or through the Services.
              </p>
            </section>
            ...
            <section class="mb-8">
              ...
              <ul class="list-disc pl-6">
                <li>Violating any law, rule, or regulation</li>
                <li>Infringing the intellectual property rights of others</li>
                <li>
                  Distributing malicious code or engaging in disruptive
                  activities
                </li>
                <li>Sending unauthorized advertising or spam</li>
                <li>Impersonating another person or entity</li>
                <li>Interfering with the proper working of the Services</li>
                <li>
                  Attempting to bypass any security measures of the Services
                </li>
              </ul>
            </section>
            ...
            <section class="mb-8">
              ...
              <p>
                ...
                shall the Company, its affiliates, agents, directors, employees,
              ...
              <ul class="list-disc pl-6">
                ...
                <li>
                  Bugs, viruses, trojan horses, or the like transmitted to or
            ...
            <section class="mb-8">
              ...
              <p>
                Upon termination, all licenses and other rights granted to you
                in these Terms will immediately cease. The Company is not liable
            ...
            <section class="mb-8">
              ...
              <p>
                ...
                version will always be on this page. If the revision, in our
                sole discretion, is material, we will notify you via email to
                the email address associated with your account or through the
                Services. By continuing to access or use the Services after
...
const policyType = ref("privacy"); // Default to privacy policy
const analytics = inject("analytics");
const contentSections = ref(null);
const observerRef = ref(null);
const visibleSections = ref(new Set());

// Set policy type based on route
onMounted(() => {
  // Determine policy type from route or query param
  if (route.params.type) {
    policyType.value = route.params.type;
  } else if (route.query.type) {
    policyType.value = route.query.type;
  }

  // Track page view
  analytics.pageView(`/policy/${policyType.value}`);
  analytics.trackEvent("Page", "view", `${policyType.value} Policy Page`);
...
const setupSectionVisibilityTracking = () => {
  contentSections.value = document.querySelectorAll("section h3");
    ...
    (entries) => {
      entries.forEach((entry) => {
        if (entry.isIntersecting) {
          ...
          if (!visibleSections.value.has(sectionTitle)) {
            visibleSections.value.add(sectionTitle);
