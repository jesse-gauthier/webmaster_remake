        ...
        <div v-if="!hasAccess" class="bg-white rounded-lg shadow-card max-w-2xl mx-auto animate-fade-in">
            <div class="p-6 md:p-8">
                <div class="text-center mb-8">
                    <h2 class="text-2xl md:text-3xl text-primary-600 font-bold mb-4">Access Your Interactive SEO
                        Checklist</h2>
                    <p class="text-neutral-700">
                        Get instant access to our comprehensive SEO checklist with 100+ actionable tasks to improve your
                        website's
                ...
                <div v-if="!isSubmitted">
                    <form @submit.prevent="submitForm" class="space-y-6">
                        ...
                        <div class="flex items-start gap-2">
                            <input type="checkbox" id="terms" v-model="agreeToTerms" class="mt-1 h-5 w-5" required />
                            <label for="terms" class="text-sm text-neutral-700">
                                I agree to receive emails from Ottawa Web Masters. You can unsubscribe at any time.
                    ...
                    <div class="mt-6 pt-6 border-t border-gray-200 text-center text-sm text-gray-600">
                        <p>
                            We respect your privacy. Your information will never be shared or sold to third parties.
                        </p>
                    </div>
                </div>
                ...
                <div v-else class="text-center py-6">
                    ...
                    <p class="text-neutral-700 mb-6">
                        Your SEO checklist is being prepared. You'll see it in just a moment.
                    </p>
                    <div class="flex justify-center">
                        <div class="w-full bg-gray-200 rounded-full h-2.5 max-w-xs">
                            <div class="bg-primary-600 h-2.5 rounded-full" :style="{ width: `${redirectProgress}%` }">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div v-else>
            <div class="bg-white rounded-lg shadow-card p-6 mb-10">
                <p class="text-lg mb-6">
                    Use this interactive checklist to track your SEO progress. Your progress will be saved automatically
                    in your browser.
                </p>
            ...
            <div class="bg-primary-50 rounded-lg p-6 text-center">
                ...
                <p class="mb-6">Our team at Ottawa Web Masters can create a personalized SEO plan to improve your
                    website's
