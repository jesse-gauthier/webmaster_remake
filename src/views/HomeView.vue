...
<template>
  <main>
    ...
    <section id="tech-stack-section" class="py-20 bg-gradient-to-br from-primary-50 via-neutral-cream to-accent-50 relative overflow-hidden">
      <!-- Background decorations -->
      <div class="absolute inset-0 overflow-hidden opacity-5">
        <div class="absolute top-20 left-20 w-64 h-64 bg-primary rounded-full animate-bounce-light"></div>
        <div class="absolute bottom-20 right-20 w-48 h-48 bg-accent rounded-full animate-bounce-light" style="animation-delay: 1s"></div>
      </div>
      ...
      <div class="container-site relative z-10">
        <div class="max-w-4xl mx-auto text-center mb-16">
          ...
          <p class="text-xl text-neutral-text leading-relaxed">
            ...
            high-performing digital solutions that stand the test of time.
          </p>
        </div>

        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <!-- Frontend Technologies -->
          <div class="group bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:scale-105 border border-accent/10">
            <div class="flex items-center mb-6">
              <div class="bg-gradient-to-br from-accent-500 to-accent-600 rounded-2xl w-16 h-16 flex items-center justify-center mr-4 group-hover:scale-110 transition-transform duration-300">
            ...
            <ul class="space-y-4">
              <li class="flex items-center gap-4 p-3 rounded-lg hover:bg-accent/5 transition-colors duration-200">
              ...
              <li class="flex items-center gap-4 p-3 rounded-lg hover:bg-accent/5 transition-colors duration-200">
                ...
                <div>
                  <span class="font-semibold text-primary-dark">JavaScript/TypeScript</span>
              ...
              <li class="flex items-center gap-4 p-3 rounded-lg hover:bg-accent/5 transition-colors duration-200">
                ...
                <div>
                  <span class="font-semibold text-primary-dark">Tailwind CSS</span>
          ...
          <div class="group bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:scale-105 border border-primary/10">
            <div class="flex items-center mb-6">
              <div class="bg-gradient-to-br from-primary-500 to-primary-600 rounded-2xl w-16 h-16 flex items-center justify-center mr-4 group-hover:scale-110 transition-transform duration-300">
                <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <ul class="space-y-4">
              <li class="flex items-center gap-4 p-3 rounded-lg hover:bg-primary/5 transition-colors duration-200">
              ...
              <li class="flex items-center gap-4 p-3 rounded-lg hover:bg-primary/5 transition-colors duration-200">
                ...
                <div>
                  <span class="font-semibold text-primary-dark">MySQL/MongoDB</span>
              ...
              <li class="flex items-center gap-4 p-3 rounded-lg hover:bg-primary/5 transition-colors duration-200">
                ...
                <div>
                  <span class="font-semibold text-primary-dark">REST/GraphQL</span>
          ...
          <!-- Platforms & Services -->
          <div class="group bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:scale-105 border border-accent-600/10">
            <div class="flex items-center mb-6">
              <div class="bg-gradient-to-br from-accent-600 to-primary-600 rounded-2xl w-16 h-16 flex items-center justify-center mr-4 group-hover:scale-110 transition-transform duration-300">
                <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <ul class="space-y-4">
              <li class="flex items-center gap-4 p-3 rounded-lg hover:bg-accent-600/5 transition-colors duration-200">
                <div class="bg-blue-100 rounded-full p-2">
              ...
              <li class="flex items-center gap-4 p-3 rounded-lg hover:bg-accent-600/5 transition-colors duration-200">
                <div class="bg-orange-100 rounded-full p-2">
                  <i class="fas fa-cloud text-orange-500 text-xl"></i>
                </div>
                <div>
                  <span class="font-semibold text-primary-dark">AWS/DigitalOcean</span>
              ...
              <li class="flex items-center gap-4 p-3 rounded-lg hover:bg-accent-600/5 transition-colors duration-200">
                ...
                <div>
                  <span class="font-semibold text-primary-dark">SSL/Security</span>
