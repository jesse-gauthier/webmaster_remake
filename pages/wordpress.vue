  ...
  <div class="min-h-screen">
    ...
    >
      ...
      <div class="absolute inset-0 overflow-hidden opacity-30">
        ...
        ></div>
        <div
          class="absolute top-40 right-32 w-3 h-3 bg-accent-400 rounded-full animate-bounce-light"
          style="animation-delay: 1.5s"
        ></div>
        <div
          class="absolute bottom-32 left-1/3 w-5 h-5 bg-primary-300 rounded-full animate-bounce-light"
      ...
      <div class="container-site px-4 sm:px-6 relative z-10">
        <div class="max-w-4xl mx-auto text-center">
          ...
          >
            Custom WordPress solutions tailored to your business needs, from
            simple websites to complex e-commerce platforms.
          </p>
    ...
    >
      ...
      <div class="container-site px-4 sm:px-6 relative z-10">
        <div class="text-center mb-16">
          ...
          <p
            class="text-xl text-neutral-text max-w-3xl mx-auto leading-relaxed mb-6"
          >
            We deliver high-quality WordPress solutions that help businesses
          ...
          >
            <Icon icon="mdi:server" width="18" height="18" aria-hidden="true" />
          ...
          >
            ...
            <div class="p-8">
              <div class="flex items-center mb-6">
                <div
                  class="w-16 h-16 bg-gradient-to-br from-primary-500 to-primary-600 rounded-2xl flex items-center justify-center mr-4 group-hover:scale-110 transition-transform duration-300"
                >
                  <Icon
                    :icon="service.icon"
                    width="28"
    ...
    >
      ...
      <div class="container-site px-4 sm:px-6 relative z-10">
        <div class="text-center mb-16">
          ...
          >
            We follow a streamlined process to ensure your WordPress project is
      ...
      <div class="container-site px-4 sm:px-6 relative z-10">
        <div class="text-center mb-16">
          ...
          >
            ...
            about our transformative WordPress services.
          </p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          >
            <div class="flex mb-6">
              <svg
                class="h-6 w-6 text-accent mr-1"
                v-for="star in 5"
                :key="star"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 20 20"
            ...
            <p class="text-neutral-text italic mb-6 text-lg leading-relaxed">
              "{{ testimonial.quote }}"
            </p>
            <div class="flex items-center">
              <div
                class="w-14 h-14 bg-gradient-to-br from-primary to-primary-600 rounded-full flex items-center justify-center text-white font-bold text-xl shadow-lg group-hover:scale-105 transition-transform duration-300"
              >
                {{ testimonial.name.charAt(0) }}
              </div>
              <div class="ml-4">
                <h5 class="font-bold text-primary text-lg mb-0">
                  {{ testimonial.name }}
                </h5>
      ...
      <div class="container-site px-4 sm:px-6 relative z-10">
        <div class="text-center max-w-4xl mx-auto">
          ...
          <p
            ...
            style="animation-delay: 0.2s"
          >
            Let's discuss how our expert WordPress development services can help
            your business grow and thrive online.
          </p>
          <div
            class="flex flex-col sm:flex-row justify-center gap-6 animate-slide-up"
            style="animation-delay: 0.3s"
    ...
    <section
      ...
      class="py-20 bg-gradient-to-br from-neutral-50 via-white to-primary-50 relative overflow-hidden"
    >
      <!-- Background decoration -->
      <div class="absolute inset-0 overflow-hidden opacity-5">
        <div
          class="absolute top-20 left-20 w-40 h-40 bg-primary rounded-full animate-bounce-light"
        ></div>
        <div
          class="absolute bottom-20 right-20 w-32 h-32 bg-accent rounded-full animate-bounce-light"
          style="animation-delay: 1s"
        ></div>
      </div>
      ...
      <div class="container-site px-4 sm:px-6 relative z-10">
        <div class="text-center mb-16">
          ...
          <p
            class="text-xl text-neutral-text max-w-3xl mx-auto leading-relaxed"
          >
            Get answers to common questions about our WordPress development
            services and expertise.
          </p>
        </div>

        <div class="max-w-4xl mx-auto">
          <div v-for="(item, index) in faqs" :key="index" class="mb-6">
            <button
            ...
            >
              <span class="font-bold text-primary text-lg pr-4">{{
                item.question
              }}</span>
              <div class="flex-shrink-0">
                <div
                  class="w-10 h-10 rounded-full bg-gradient-to-br from-primary to-primary-600 flex items-center justify-center"
                >
                  <svg
            ...
            >
              <div class="pt-6">
                <p class="text-neutral-text text-lg leading-relaxed mb-0">
                  {{ item.answer }}
                </p>
              </div>
            </div>
