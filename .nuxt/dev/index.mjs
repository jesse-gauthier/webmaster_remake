...
import destr, { destr as destr$1 } from 'file://C:/Users/jesse/Documents/github/webmaster_remake/node_modules/destr/dist/index.mjs';
import { renderToString } from 'file://C:/Users/jesse/Documents/github/webmaster_remake/node_modules/vue/server-renderer/index.mjs';
import { klona } from 'file://C:/Users/jesse/Documents/github/webmaster_remake/node_modules/klona/dist/index.mjs';
import defu, { defuFn, defu as defu$1, createDefu } from 'file://C:/Users/jesse/Documents/github/webmaster_remake/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file://C:/Users/jesse/Documents/github/webmaster_remake/node_modules/scule/dist/index.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file://C:/Users/jesse/Documents/github/webmaster_remake/node_modules/nuxt/node_modules/unhead/dist/server.mjs';
import { stringify, uneval } from 'file://C:/Users/jesse/Documents/github/webmaster_remake/node_modules/devalue/index.js';
import { isVNode, toValue, isRef } from 'file://C:/Users/jesse/Documents/github/webmaster_remake/node_modules/vue/index.mjs';
import { createHooks } from 'file://C:/Users/jesse/Documents/github/webmaster_remake/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file://C:/Users/jesse/Documents/github/webmaster_remake/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file://C:/Users/jesse/Documents/github/webmaster_remake/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, prefixStorage } from 'file://C:/Users/jesse/Documents/github/webmaster_remake/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://C:/Users/jesse/Documents/github/webmaster_remake/node_modules/unstorage/drivers/fs.mjs';
import { digest } from 'file://C:/Users/jesse/Documents/github/webmaster_remake/node_modules/ohash/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file://C:/Users/jesse/Documents/github/webmaster_remake/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { consola as consola$1, createConsola } from 'file://C:/Users/jesse/Documents/github/webmaster_remake/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file://C:/Users/jesse/Documents/github/webmaster_remake/node_modules/youch-core/build/index.js';
import { Youch } from 'file://C:/Users/jesse/Documents/github/webmaster_remake/node_modules/nitropack/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file://C:/Users/jesse/Documents/github/webmaster_remake/node_modules/source-map/source-map.js';
import { AsyncLocalStorage } from 'node:async_hooks';
import { getContext } from 'file://C:/Users/jesse/Documents/github/webmaster_remake/node_modules/unctx/dist/index.mjs';
import { captureRawStackTrace, parseRawStackTrace } from 'file://C:/Users/jesse/Documents/github/webmaster_remake/node_modules/errx/dist/index.js';
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:/Users/jesse/Documents/github/webmaster_remake","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:/Users/jesse/Documents/github/webmaster_remake/server","watchOptions":{"ignored":[null]}}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:/Users/jesse/Documents/github/webmaster_remake/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:/Users/jesse/Documents/github/webmaster_remake/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"C:/Users/jesse/Documents/github/webmaster_remake/.data/kv"}));
...
const _inlineRuntimeConfig = {
    ...
    "stack": [
      {
        "_context": "system",
        "_priority": -15,
        "name": "webmaster_remake",
        "env": "development"
      },
      {
        "_context": "package.json",
        "_priority": -10,
        "name": "webmasters_remake"
      }
    ],
    "version": "3.2.2",
    "debug": false,
  ...
  "nuxt-robots": {
    ...
    "groups": [
      {
        ...
        "_rules": [
          ...
          {
            "pattern": "/form-submission-success",
            "allow": false
          },
          {
            "pattern": "/form-submission-error",
            "allow": false
          },
          {
            "pattern": "/startup",
    ...
    "sitemap": [
      "https://ottawawebmasters.ca/sitemap.xml",
      "/sitemap.xml"
    ],
    "header": true,
...
const _7t38teAwn4dkcFbG7a9N5wxvLl09MD1e7DITDzrRiQ4 = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "C:/Users/jesse/Documents/github/webmaster_remake";

const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"name":"description","content":"Professional web development and SEO services. Custom websites, WordPress, Vue.js, and comprehensive SEO solutions."}],"link":[{"rel":"icon","type":"image/x-icon","href":"/favicon.ico"}],"style":[],"script":[],"noscript":[],"title":"Webmaster Services - Professional Web Development & SEO","htmlAttrs":{"lang":"en"}};
...
const _lqGXH8B5RjI0fb7lS2zGsRhFYvGjt0T5ieueSzi5qo = (nitroApp) => {
...
const _HAfMo60Vi4_RuO0RnRVsIQ2jxbz6XyTMDxV5M8dZJDY = defineNitroPlugin(async (nitroApp) => {
...
const _xKH1JSVKqDxui8BvGiRzn8pYXXyT7Qsp4sBB_bFMHu0 = defineNitroPlugin(async (nitroApp) => {
...
const plugins = [
  _7t38teAwn4dkcFbG7a9N5wxvLl09MD1e7DITDzrRiQ4,
_lqGXH8B5RjI0fb7lS2zGsRhFYvGjt0T5ieueSzi5qo,
_HAfMo60Vi4_RuO0RnRVsIQ2jxbz6XyTMDxV5M8dZJDY,
_xKH1JSVKqDxui8BvGiRzn8pYXXyT7Qsp4sBB_bFMHu0
];
...
const _pKxWvB = eventHandler((event) => {
...
const _YA8Lgr = eventHandler(async (e) => {
  if (e.context._initedSiteConfig)
    return;
...
const _jgrT0j = eventHandler(async (e) => {
...
const _WBeC9e = defineEventHandler(async (e) => {
  const nitroApp = useNitroApp();
...
const _Ap6f0Y = defineEventHandler(async (e) => {
...
const _jB9p7a = defineEventHandler(async (e) => {
...
const _iqzCTU = defineEventHandler(async (e) => {
  const query = getQuery$1(e);
...
async function parseSitemapXml(xml) {
  ...
  const { XMLParser } = await import('file://C:/Users/jesse/Documents/github/webmaster_remake/node_modules/fast-xml-parser/src/fxp.js');
...
const _Ztvuxg = defineEventHandler(async (e) => {
...
const _GEEAZN = defineEventHandler(async (e) => {
...
const _UEpRjd = defineEventHandler(async (e) => {
...
const getServerEntry = () => import('file://C:/Users/jesse/Documents/github/webmaster_remake/.nuxt//dist/server/server.mjs').then((r) => r.default || r);
const getClientManifest = () => import('file://C:/Users/jesse/Documents/github/webmaster_remake/.nuxt//dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
...
const handlers = [
  { route: '', handler: _pKxWvB, lazy: false, middleware: true, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_1soMBS, lazy: true, middleware: false, method: undefined },
  { route: '', handler: _YA8Lgr, lazy: false, middleware: true, method: undefined },
  { route: '/__site-config__/debug.json', handler: _jgrT0j, lazy: false, middleware: false, method: undefined },
  { route: '/robots.txt', handler: _WBeC9e, lazy: false, middleware: false, method: undefined },
