  ...
  <section id="audit" class="py-16 bg-primary-600 text-white">
    <div class="container-site">
      <div class="max-w-3xl mx-auto text-center">
        ...
        <p class="text-lg mb-8 text-primary-100">
          Discover how your website measures up against competitors and get
          actionable insights to boost your online visibility.
        </p>
        <div class="bg-white rounded-lg shadow-lg p-8 max-w-xl mx-auto">
          <h3 class="text-2xl font-bold text-primary-700 mb-4">
          ...
          <form class="space-y-4" @submit.prevent="submitForm">
            ...
            <p
              v-if="formState.message && !formState.success"
              class="mt-4 text-sm text-red-600"
            >
              {{ formState.message }}
            </p>
            <p class="text-xs text-neutral-600 text-center mt-4">
              We'll analyze your website and send you a detailed report within 2
              business days.
            </p>
          </form>
        </div>
    ...
    <Transition name="fade">
      <div
        ...
        class="fixed inset-0 flex items-center justify-center z-modal"
      >
        <!-- Backdrop -->
        <div
        ...
        <!-- Modal Content -->
        <div
          class="bg-white rounded-lg shadow-xl p-8 max-w-md w-full mx-4 relative z-10 animate-slide-up"
        >
          <button
            @click="closeModal"
          ...
          <!-- CTA Button -->
          <button @click="closeModal" class="btn-primary w-full">Got It</button>

          <!-- Additional Info -->
          <p class="text-xs text-neutral-500 text-center mt-4">
            Have questions? Contact us at
            <a
              href="mailto:support@webmaster.com"
              class="text-accent-600 hover:underline"
              >contact@ottawawebmasters.com</a
            >
          </p>
        </div>
      </div>
