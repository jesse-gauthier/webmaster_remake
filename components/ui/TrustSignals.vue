      ...
      <div class="container-site">
        <div class="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
          <div class="text-white" v-for="stat in stats" :key="stat.label">
            ...
            <div class="text-primary-light text-sm md:text-base">{{ stat.label }}</div>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="py-8 bg-white">
      <div class="container-site">
        <div class="flex flex-wrap justify-center items-center gap-8">
          <div v-for="badge in trustBadges" :key="badge.name" class="flex items-center space-x-2">
    ...
    <div class="py-12 bg-accent-light">
      <div class="container-site text-center">
        <div class="max-w-2xl mx-auto">
          ...
          <h3 class="text-2xl font-bold text-primary mb-4">100% Satisfaction Guarantee</h3>
          <p class="text-gray-600">
            We stand behind our work with a 30-day money-back guarantee. 
            If you're not completely satisfied with your website, we'll refund your investment.
          </p>
        </div>
      </div>
    </div>
